...
ステータス: ステップ1〜5 実装済み(v0.3.0、実機検証済み。doc/verification-2026-07-13.ja.md 参照。移行期の v3 モジュールはクレートルートへ統合済み)。共有ピン SWD/JTAG 実行時切替(swj 構成)も BitBangSwj として実装・実機検証済み。残: PIO 版 swj、xiao_m0 の BSP 更新+RTIC 化。
